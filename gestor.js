...
server.get('/tareas/:id', (req, res) => {
    ...
    const tarea = modelos.find((tarea) => tarea.id === id)
...
server.put('/tareas/:id', (req, res) => {
    ...
    const Index = modelos.findIndex((tarea) => tarea.id === id)
...
server.delete('/tareas/:id', (req, res) => {
    ...
    const findID = modelos.findID( (tarea) => tarea.id === id)
